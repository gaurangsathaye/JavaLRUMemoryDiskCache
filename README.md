...
* **Memory and disk storage**: Cached objects are stored in memory and disk (optional). In case you restart your process, the in memory cache will be lazy loaded from disk.
