...
* **Concurrency and thread safety**: Cache can be used in high load multi request and multi thread environments.  Reads are fully concurrent, writes have a high level of concurrency due to two stage write locks.
